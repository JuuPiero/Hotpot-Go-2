export class Perlin {
    private static permutation = [
        ...
        38,147,118,126,255,82,85,212,207,206,59,
        227,47,16,58,17,182,189,28,42,223,183,
        ...
        254,138,236,205,93,222,114,67,29,24,72,
    ...
    static grad(hash: number, x: number, y: number) {
        const h = hash & 3;
        const u = h < 2 ? x : y;
        const v = h < 2 ? y : x;
